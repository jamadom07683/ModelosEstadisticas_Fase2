...
Hemos seleccionado estas 12 variables porque consideramos que nos ofrecen una visión integral del desempeño de los microestablecimientos en Colombia. A continuación, explicamos cada una y su relevancia en el análisis.
...
P1087 (Computadores de escritorio) y P1088 (Computadores portátiles): Reflejan el nivel tecnológico disponible.
...
P1093 (Uso de Internet dentro del establecimiento) y P1094 (Uso fuera del establecimiento): Permiten evaluar la conectividad y productividad.
...
CDGO_DPRTMNTO (Código de departamento): Ayuda a contextualizar geográficamente los establecimientos, permitiendo análisis regionales (Por ejemplo el costo de la energia electrica)
