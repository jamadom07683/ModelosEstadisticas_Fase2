...
# Agrupar por 'P2532' y calcular la media de 'P1010'
grpie <- variables_seleccionadas %>%
  group_by(P2532) %>%
  summarise(media_P1010 = mean(P1010, na.rm=TRUE))

# Extraer etiquetas y tamaños
labels <- ifelse(grpie$P2532 == 1, "Con Internet", "Sin Internet")
...
pie_labels <- paste0(labels, " - ", round(100 * sizes/sum(sizes), 2), "%")

# Crear gráfico de pastel
pie(sizes, labels = pie_labels, col = color, main = "Distribución de Ventas Promedio por Presencia de Internet")

# Añadir leyenda
legend("topleft", legend = labels, fill = color)
...
# Gráfico de barras para la variable P2532 con ggplot2
ggplot(variables_seleccionadas, aes(x = P2532)) +
  geom_bar(fill = "green", color = "black") +
  labs(title = "Presencia de Página Web en los Establecimientos",
       x = "Tiene Página Web",
       y = "Frecuencia") +
  theme_minimal() 
